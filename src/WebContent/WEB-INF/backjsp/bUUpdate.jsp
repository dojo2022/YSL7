 ...
 <% session.setAttribute("profile", "profile"); %>
	...
	<input type="hidden" name="page_id" value="BR02">
		<table>
			<tr>
				<td>社員番号</td>
				<td><input type="text" name="number" value="${profle.number}"><br> <span id="error_number"></span></td>

			</tr>
			<tr>
				<td>氏名</td>
				<td><input type="text" name="name" value="${profle.name}"><br> <span id="error_name"></span></td>
			</tr>
			<tr>
				<td>性別</td>
				<td>
					<select name="gender">
						<option value="" id="uUpdateGender">性別を選択</option>
			...
			<tr>
				...
				<td>
					<select name="post1">
					    ...
					    <option value="10"><c:if test=${profile.postId==1o}selected></c:if>取締役</option>
					  </select><br>
			...
			<tr>
				...
				<td>
					<select name="year">
						<option value="${profle.year}">${profle.year}</option>
